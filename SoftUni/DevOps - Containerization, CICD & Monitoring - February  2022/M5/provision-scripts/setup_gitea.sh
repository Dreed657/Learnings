...
cd /tmp/bgapp && git push -o repo.private=false http://vagrant:vagrant@192.168.99.102:3000/vagrant/bgapp

# Add a Webhook
curl -X 'POST' 'http://192.168.99.102:3000/api/v1/repos/vagrant/bgapp/hooks' \
